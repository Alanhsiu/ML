...
Original file is located at
    https://colab.research.google.com/drive/1EdIIr4hOT7gJwWAtYeT2GzssUbZJVdtS
...
!cp -r '/content/drive/MyDrive/libriphone' libriphone
...
model_path1 = './model1.ckpt'     # the path where the checkpoint will be saved

# model parameters
input_dim = 39 * concat_nframes # the input dim of the model, you should not change the value
hidden_layers = 3               # the number of hidden layers
# hidden_layers1 = 5               # the number of hidden layers
hidden_dim = 2048                # the hidden dim
# hidden_dim1 = 1024                # the hidden dim
...
# model1 = Classifier1(input_dim=input_dim, hidden_layers=hidden_layers1, hidden_dim=hidden_dim1).to(device)
...
with torch.no_grad():
    for i, batch in enumerate(tqdm(test_loader)):
        ...
        outputs = model(features)
        # outputs = (model(features)+model1(features))/2
